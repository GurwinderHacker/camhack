...
${green}                                               [By Learn With Gurwinder YT]
"
...
trap "echo -e '\n${success}Thanks for Using! Subscribe Learn With Gurwinder'; exit" 2
...
sleep 1
printf "${cyan}\nGurwinder${nc}@${blue}hacker ${red}$ ${nc}"
read option
# Select template
    if echo $option | grep -q "1"; then
        dir="jio"
...
$red[Author]     ${cyan} :[Gurwinder]
$red[Github]     ${cyan} :[https://github.com/hackerxGurwinder] 
$red[Join us]    ${cyan} :[https://bit.ly/3PV3S3r]
$red[Telegarm]   ${cyan} :[https://t.me/x_PH4N7OM]"
printf "${cyan}\nGurwinder${nc}@${cyan}hacker ${red}$ ${nc}"
read about
...
cd $dir
netcheck
wget -q --show-progress "https://github.com/hacker/files/raw/main/${dir}.zip"
